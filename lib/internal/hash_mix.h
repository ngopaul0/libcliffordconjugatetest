...
// Ref: https://github.com/boostorg/container_hash/blob/5d8b8ac2b9d9d7cb3818f88fd7e6372e5f072ff5/include/boost/container_hash/hash.hpp#L472
// Ref: https://github.com/boostorg/container_hash/blob/5d8b8ac2b9d9d7cb3818f88fd7e6372e5f072ff5/include/boost/container_hash/detail/hash_mix.hpp#L71
template <class T>
void hash_combine(std::size_t& seed, T const& v){
    std::hash<T> hasher;
    seed = hash_mix( seed + 0x9e3779b9 + hasher(v) );
}

// Ref: https://github.com/boostorg/container_hash/blob/5d8b8ac2b9d9d7cb3818f88fd7e6372e5f072ff5/include/boost/container_hash/hash.hpp#L235
template <class T>
std::size_t hash_pair(T const& l, T const& r) {
    std::size_t seed = 0;
    hash_combine(seed, l);
    hash_combine(seed, r);
    return seed;
